...
\tituloPT{Título da Tese ou Dissertação..........}
\tituloEN{Title of thesis or dissertation............}
\autor[Tal, A. F.]{Aluno Fulano de Tal}
\genero{M} % Gênero do autor (M = Masculino / F = Feminino)
\orientador[Orientador]{Prof. Dr.}{Nome do Orientador}
%\coorientador{Prof. Dr.}{Fulano de Tal}
\curso{CCMC}
\data{20}{08}{2021} % Data do depósito
...
\input{tex/part/part1}
%\textopart*{tex/part/part1}
\chapter{Introdução}
\label{chapter:cap1-introducao}
\input{tex/chapters/cap1-introducao}

\input{tex/part/part2}
\chapter{Design da Pesquisa}
\label{chapter:cap2-design-pesquisa}
\input{tex/chapters/cap2-design-pesquisa}
